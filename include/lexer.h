...
public:
    ...
    const T& Expect() const {
        ...
        if (current_token_.Is<T>()) {
            ...
            throw LexerError("Expect fail"s);
    }
    ...
    void Expect(const U& value) const {
        using namespace std::literals;
        if (current_token_.Is<T>()) {
            if (current_token_.As<T>().value == value) return;
        }
        throw LexerError("Expect value fail"s);
    }
    ...
    const T& ExpectNext() {
        ...
        if (current_token_.Is<T>()) {
            ...
            throw LexerError("ExpectNext fail"s);
    }
    ...
    void ExpectNext(const U& value) {
        ...
        throw LexerError("ExpectNext value fail"s);
    }
